...
import image6 from "../assests/image12.jpg";
  ...
  return (
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-wrap -m-4">
          ...
          <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
            <a class="block relative h-48 rounded overflow-hidden">
              <img
                alt="ecommerce"
                class="object-cover object-cover w-full h-full block"
                src={image2}
                height="100"
                width="100"
              ></img>
        ...
        <Link to="/viewall">
          <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg cen">
            View All
          </button>
        </Link>
      </div>
